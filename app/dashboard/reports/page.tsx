...
import { getReports, getReportTemplates, deleteReport } from '@/app/actions/reports'
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (reportsResult.success && reportsResult.reports) {
        setReports(reportsResult.reports as any)
      }
        ...
        >
          <div className="flex items-center justify-center h-[400px]">
            <div className="text-center">
              <FileBarChart className="h-12 w-12 text-muted-foreground mx-auto mb-4 animate-pulse" />
