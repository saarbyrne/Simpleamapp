...
export function ReportViewClient({ reportId, initialReport, initialReportData, initialAction }: ReportViewClientProps) {
  ...
  const [showShareDialog, setShowShareDialog] = useState(initialAction === 'share')
