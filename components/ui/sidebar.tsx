...
>(
  (
    ...
    // Read cookie value on mount to restore sidebar state
    ...
    const [_open, _setOpen] = React.useState(() => {
      // Read from cookie on initial mount
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex w-full flex-1 flex-col bg-background min-w-0 max-w-full overflow-x-hidden",
