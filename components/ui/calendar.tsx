  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: cn("flex flex-col w-full gap-4 relative", defaultClassNames.month),
        nav: cn(
          "flex items-center gap-1 absolute top-0 left-0 right-0 justify-between z-10",
        ...
        month_caption: cn(
          "flex items-center justify-center h-8 w-full relative",
