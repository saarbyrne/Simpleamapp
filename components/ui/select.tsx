  ...
  return (
    <SelectPrimitive.Trigger
      ...
      style={{
        ...
        height: size === "sm" ? tokens.spacing.spacing.xl : tokens.spacing.spacing['2xl'],
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground relative flex w-full cursor-default items-center outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      style={{
        gap: tokens.spacing.gap.sm,
    ...
    >
      <span
        ...
        style={{ right: tokens.spacing.spacing.sm }}
      >
