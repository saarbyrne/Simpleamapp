...
export function DashboardShell({ currentPage, title, children }: DashboardShellProps) {
  return (
    <SidebarProvider>
      <AppSidebar currentPage={currentPage} />
      <SidebarInset className="transition-[margin-left] duration-200 md:ml-[var(--sidebar-width)] peer-data-[state=collapsed]:md:ml-[var(--sidebar-width-icon)]">
